...
def get_item_children(
    item: Union[int, str], slot: int = -1
) -> Union[dict, List[int], None]:
...
def staging_container(**kwargs):
    ...
    try:
        warnings.warn(
            "'staging_container' is deprecated and was changed to 'stage'",
            DeprecationWarning,
            2,
        )
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            ...
            tag = kwargs["id"]
        widget = internal_dpg.add_child_window(
            label=label,
            user_data=user_data,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_clipper(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_collapsing_header(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_colormap_registry(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_custom_series(
            x,
            y,
            channel_count,
            label=label,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_drag_payload(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_draw_layer(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_draw_node(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_drawlist(
            width,
            height,
            label=label,
            user_data=user_data,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_file_dialog(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_filter_set(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
...
def font(
    ...
    *,
    ...
    parent: Union[int, str] = internal_dpg.mvReservedUUID_0,
    **kwargs,
) -> Union[int, str]:
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_font_registry(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_handler_registry(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_item_handler_registry(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_menu_bar(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_node_attribute(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_node_editor(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
...
def plot(
    *,
    ...
    query: bool = False,
    query_color: Union[List[float], Tuple[float, ...]] = (0, 255, 0, 255),
    ...
    pan_button: int = internal_dpg.mvMouseButton_Left,
    pan_mod: int = internal_dpg.mvKey_None,
    context_menu_button: int = internal_dpg.mvMouseButton_Right,
    fit_button: int = internal_dpg.mvMouseButton_Left,
    box_select_button: int = internal_dpg.mvMouseButton_Right,
    box_select_mod: int = internal_dpg.mvKey_None,
    box_select_cancel_button: int = internal_dpg.mvMouseButton_Left,
    query_toggle_mod: int = internal_dpg.mvKey_ModCtrl,
    horizontal_mod: int = internal_dpg.mvKey_ModAlt,
    vertical_mod: int = internal_dpg.mvKey_ModShift,
    override_mod: int = internal_dpg.mvKey_ModCtrl,
    zoom_mod: int = internal_dpg.mvKey_None,
    zoom_rate: int = 0.1,
    **kwargs,
) -> Union[int, str]:
...
def plot_axis(
    ...
    *,
    ...
    tick_format: str = "",
    scale: int = internal_dpg.mvPlotScale_Linear,
    invert: bool = False,
    auto_fit: bool = False,
    ...
    **kwargs,
    ...
    try:
        ...
        if "log_scale" in kwargs.keys():
            warnings.warn(
                "log_scale keyword deprecated. See the new scale argument.",
                DeprecationWarning,
                2,
            )
        ...
        if "time" in kwargs.keys():
            warnings.warn(
                "time keyword deprecated. See the new scale argument.",
                DeprecationWarning,
                2,
            )
        widget = internal_dpg.add_plot_axis(
            axis,
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_subplots(
            rows,
            columns,
            label=label,
            user_data=user_data,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_tab_bar(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_table_cell(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_table_row(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_template_registry(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_texture_registry(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_theme_component(
            item_type,
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_tooltip(
            parent,
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_tree_node(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_value_registry(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_viewport_drawlist(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_viewport_menu_bar(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
    ...
    **kwargs,
    ...
    try:
        if "id" in kwargs.keys():
            warnings.warn("id keyword renamed to tag", DeprecationWarning, 2)
            tag = kwargs["id"]
        widget = internal_dpg.add_window(
            label=label,
            user_data=user_data,
            use_internal_label=use_internal_label,
            tag=tag,
...
def add_2d_histogram_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_2d_histogram_series(
        x,
        y,
        label=label,
        user_data=user_data,
...
def add_3d_slider(
    ...
    **kwargs,
    ...
    return internal_dpg.add_3d_slider(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_area_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_area_series(
        x,
        y,
        label=label,
        user_data=user_data,
...
def add_axis_tag(
    ...
    **kwargs,
    ...
    return internal_dpg.add_axis_tag(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_bar_group_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_bar_group_series(
        values,
        label_ids,
        group_size,
        label=label,
...
def add_bar_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_bar_series(
        x,
        y,
        label=label,
        user_data=user_data,
...
def add_bool_value(
    ...
    **kwargs,
    ...
    return internal_dpg.add_bool_value(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_button(
    ...
    **kwargs,
    ...
    return internal_dpg.add_button(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_candle_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_candle_series(
        dates,
        opens,
        closes,
        lows,
...
def add_char_remap(
    ...
    **kwargs,
    ...
    return internal_dpg.add_char_remap(
        source,
        target,
        label=label,
        user_data=user_data,
...
def add_checkbox(
    ...
    **kwargs,
    ...
    return internal_dpg.add_checkbox(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_child_window(
    ...
    **kwargs,
    ...
    return internal_dpg.add_child_window(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_clipper(
    ...
    **kwargs,
    ...
    return internal_dpg.add_clipper(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_collapsing_header(
    ...
    **kwargs,
    ...
    return internal_dpg.add_collapsing_header(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_color_button(
    ...
    **kwargs,
    ...
    return internal_dpg.add_color_button(
        default_value,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_color_edit(
    ...
    *,
    ...
    alpha_preview: int = 0,
    display_mode: int = internal_dpg.mvColorEdit_rgb,
    display_type: int = internal_dpg.mvColorEdit_uint8,
    input_mode: int = internal_dpg.mvColorEdit_input_rgb,
    **kwargs,
) -> Union[int, str]:
    ...
    return internal_dpg.add_color_edit(
        default_value,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_color_picker(
    ...
    *,
    ...
    picker_mode: int = internal_dpg.mvColorPicker_bar,
    alpha_preview: int = 0,
    display_type: int = internal_dpg.mvColorEdit_uint8,
    input_mode: int = internal_dpg.mvColorEdit_input_rgb,
    **kwargs,
    ...
    return internal_dpg.add_color_picker(
        default_value,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_colormap(
    ...
    *,
    ...
    tag: Union[int, str] = 0,
    show: bool = True,
    parent: Union[int, str] = internal_dpg.mvReservedUUID_4,
    **kwargs,
) -> Union[int, str]:
    ...
    return internal_dpg.add_colormap(
        colors,
        qualitative,
        label=label,
        user_data=user_data,
...
def add_colormap_button(
    ...
    **kwargs,
    ...
    return internal_dpg.add_colormap_button(
        default_value,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_colormap_registry(
    ...
    **kwargs,
    ...
    return internal_dpg.add_colormap_registry(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_colormap_scale(
    ...
    **kwargs,
    ...
    return internal_dpg.add_colormap_scale(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_colormap_slider(
    ...
    **kwargs,
    ...
    return internal_dpg.add_colormap_slider(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_custom_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_custom_series(
        x,
        y,
        channel_count,
        label=label,
...
def add_date_picker(
    ...
    **kwargs,
    ...
    return internal_dpg.add_date_picker(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_digital_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_digital_series(
        x,
        y,
        label=label,
        user_data=user_data,
...
def add_double4_value(
    ...
    **kwargs,
    ...
    return internal_dpg.add_double4_value(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_double_value(
    ...
    **kwargs,
    ...
    return internal_dpg.add_double_value(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_drag_double(
    ...
    **kwargs,
    ...
    return internal_dpg.add_drag_double(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_drag_doublex(
    ...
    **kwargs,
    ...
    return internal_dpg.add_drag_doublex(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_drag_float(
    ...
    **kwargs,
    ...
    return internal_dpg.add_drag_float(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_drag_floatx(
    ...
    **kwargs,
    ...
    return internal_dpg.add_drag_floatx(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_drag_int(
    ...
    **kwargs,
    ...
    return internal_dpg.add_drag_int(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_drag_payload(
    ...
    **kwargs,
    ...
    return internal_dpg.add_drag_payload(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_drag_point(
    *,
    ...
    thickness: float = 1.0,
    show_label: bool = True,
    offset: Union[List[float], Tuple[float, ...]] = (16.0, 8.0),
    clamped: bool = True,
    delayed: bool = False,
    no_cursor: bool = False,
    no_fit: bool = False,
    ...
    **kwargs,
    ...
    return internal_dpg.add_drag_point(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_drag_rect(
    ...
    **kwargs,
    ...
    return internal_dpg.add_drag_rect(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_draw_layer(
    ...
    **kwargs,
    ...
    return internal_dpg.add_draw_layer(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_draw_node(
    ...
    **kwargs,
    ...
    return internal_dpg.add_draw_node(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_drawlist(
    ...
    **kwargs,
    ...
    return internal_dpg.add_drawlist(
        width,
        height,
        label=label,
        user_data=user_data,
...
def add_dynamic_texture(
    ...
    *,
    ...
    use_internal_label: bool = True,
    tag: Union[int, str] = 0,
    parent: Union[int, str] = internal_dpg.mvReservedUUID_2,
    **kwargs,
) -> Union[int, str]:
    """Adds a dynamic texture.
    ...
    return internal_dpg.add_dynamic_texture(
        width,
        height,
        default_value,
        label=label,
...
def add_error_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_error_series(
        x,
        y,
        negative,
        positive,
...
def add_file_dialog(
    ...
    **kwargs,
    ...
    return internal_dpg.add_file_dialog(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_file_extension(
    ...
    **kwargs,
    ...
    return internal_dpg.add_file_extension(
        extension,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_filter_set(
    ...
    **kwargs,
    ...
    return internal_dpg.add_filter_set(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_float4_value(
    ...
    **kwargs,
    ...
    return internal_dpg.add_float4_value(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_float_value(
    ...
    **kwargs,
    ...
    return internal_dpg.add_float_value(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_float_vect_value(
    ...
    **kwargs,
    ...
    return internal_dpg.add_float_vect_value(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_font_chars(
    ...
    **kwargs,
    ...
    return internal_dpg.add_font_chars(
        chars,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_font_range(
    ...
    **kwargs,
    ...
    return internal_dpg.add_font_range(
        first_char,
        last_char,
        label=label,
        user_data=user_data,
...
def add_font_range_hint(
    ...
    **kwargs,
    ...
    return internal_dpg.add_font_range_hint(
        hint,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_font_registry(
    ...
    **kwargs,
    ...
    return internal_dpg.add_font_registry(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_handler_registry(
    ...
    **kwargs,
    ...
    return internal_dpg.add_handler_registry(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_heat_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_heat_series(
        x,
        rows,
        cols,
        label=label,
...
def add_image_button(
    ...
    **kwargs,
    ...
    if "frame_padding" in kwargs.keys():
        warnings.warn(
            "frame_padding keyword deprecated. This is not supported anymore by ImGui but still used here as deprecated.",
            DeprecationWarning,
            2,
        )
...
def add_image_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_image_series(
        texture_tag,
        bounds_min,
        bounds_max,
        label=label,
...
def add_inf_line_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_inf_line_series(
        x,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_input_doublex(
    ...
    **kwargs,
    ...
    return internal_dpg.add_input_doublex(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_input_float(
    ...
    **kwargs,
    ...
    return internal_dpg.add_input_float(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_input_floatx(
    ...
    **kwargs,
    ...
    return internal_dpg.add_input_floatx(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_input_int(
    ...
    **kwargs,
    ...
    return internal_dpg.add_input_int(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_input_intx(
    ...
    **kwargs,
    ...
    return internal_dpg.add_input_intx(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_input_text(
    ...
    **kwargs,
    ...
    return internal_dpg.add_input_text(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_int4_value(
    ...
    **kwargs,
    ...
    return internal_dpg.add_int4_value(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_int_value(
    ...
    **kwargs,
    ...
    return internal_dpg.add_int_value(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_item_activated_handler(
    *,
    label: str = None,
    user_data: Any = None,
    use_internal_label: bool = True,
    ...
    **kwargs,
    ...
    return internal_dpg.add_item_activated_handler(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_item_active_handler(
    ...
    **kwargs,
    ...
    return internal_dpg.add_item_active_handler(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_item_clicked_handler(
    ...
    **kwargs,
    ...
    return internal_dpg.add_item_clicked_handler(
        button,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_item_deactivated_after_edit_handler(
    *,
    label: str = None,
    user_data: Any = None,
    use_internal_label: bool = True,
    ...
    **kwargs,
    ...
    return internal_dpg.add_item_deactivated_after_edit_handler(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_item_deactivated_handler(
    *,
    label: str = None,
    user_data: Any = None,
    use_internal_label: bool = True,
    ...
    **kwargs,
    ...
    return internal_dpg.add_item_deactivated_handler(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_item_double_clicked_handler(
    button: int = -1,
    *,
    label: str = None,
    user_data: Any = None,
    ...
    **kwargs,
    ...
    return internal_dpg.add_item_double_clicked_handler(
        button,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_item_edited_handler(
    ...
    **kwargs,
    ...
    return internal_dpg.add_item_edited_handler(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_item_handler_registry(
    ...
    **kwargs,
    ...
    return internal_dpg.add_item_handler_registry(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_item_hover_handler(
    ...
    **kwargs,
    ...
    return internal_dpg.add_item_hover_handler(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_item_resize_handler(
    ...
    **kwargs,
    ...
    return internal_dpg.add_item_resize_handler(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_item_toggled_open_handler(
    *,
    label: str = None,
    user_data: Any = None,
    use_internal_label: bool = True,
    ...
    **kwargs,
    ...
    return internal_dpg.add_item_toggled_open_handler(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_item_visible_handler(
    ...
    **kwargs,
    ...
    return internal_dpg.add_item_visible_handler(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_key_down_handler(
    key: int = internal_dpg.mvKey_None,
    *,
    label: str = None,
    user_data: Any = None,
    use_internal_label: bool = True,
    ...
    callback: Callable = None,
    show: bool = True,
    parent: Union[int, str] = internal_dpg.mvReservedUUID_1,
    **kwargs,
) -> Union[int, str]:
    ...
    return internal_dpg.add_key_down_handler(
        key,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_key_press_handler(
    ...
    **kwargs,
    ...
    return internal_dpg.add_key_press_handler(
        key,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_key_release_handler(
    ...
    **kwargs,
    ...
    return internal_dpg.add_key_release_handler(
        key,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_knob_float(
    ...
    **kwargs,
    ...
    return internal_dpg.add_knob_float(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_line_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_line_series(
        x,
        y,
        label=label,
        user_data=user_data,
...
def add_listbox(
    ...
    **kwargs,
    ...
    return internal_dpg.add_listbox(
        items,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_loading_indicator(
    ...
    **kwargs,
    ...
    return internal_dpg.add_loading_indicator(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_menu_bar(
    ...
    **kwargs,
    ...
    return internal_dpg.add_menu_bar(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_mouse_click_handler(
    ...
    **kwargs,
    ...
    return internal_dpg.add_mouse_click_handler(
        button,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_mouse_double_click_handler(
    ...
    **kwargs,
    ...
    return internal_dpg.add_mouse_double_click_handler(
        button,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_mouse_down_handler(
    ...
    **kwargs,
    ...
    return internal_dpg.add_mouse_down_handler(
        button,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_mouse_drag_handler(
    ...
    **kwargs,
    ...
    return internal_dpg.add_mouse_drag_handler(
        button,
        threshold,
        label=label,
        user_data=user_data,
...
def add_mouse_move_handler(
    ...
    **kwargs,
    ...
    return internal_dpg.add_mouse_move_handler(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_mouse_release_handler(
    ...
    **kwargs,
    ...
    return internal_dpg.add_mouse_release_handler(
        button,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_mouse_wheel_handler(
    ...
    **kwargs,
    ...
    return internal_dpg.add_mouse_wheel_handler(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_node_attribute(
    ...
    **kwargs,
    ...
    return internal_dpg.add_node_attribute(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_node_editor(
    ...
    **kwargs,
    ...
    return internal_dpg.add_node_editor(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_node_link(
    ...
    **kwargs,
    ...
    return internal_dpg.add_node_link(
        attr_1,
        attr_2,
        label=label,
        user_data=user_data,
...
def add_pie_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_pie_series(
        x,
        y,
        radius,
        values,
...
def add_plot_annotation(
    ...
    **kwargs,
    ...
    return internal_dpg.add_plot_annotation(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_plot_axis(
    ...
    **kwargs,
    ...
    return internal_dpg.add_plot_axis(
        axis,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_plot_legend(
    ...
    **kwargs,
    ...
    return internal_dpg.add_plot_legend(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_progress_bar(
    ...
    **kwargs,
    ...
    return internal_dpg.add_progress_bar(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_radio_button(
    ...
    **kwargs,
    ...
    return internal_dpg.add_radio_button(
        items,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_raw_texture(
    ...
    *,
    ...
    use_internal_label: bool = True,
    tag: Union[int, str] = 0,
    format: int = internal_dpg.mvFormat_Float_rgba,
    parent: Union[int, str] = internal_dpg.mvReservedUUID_2,
    **kwargs,
) -> Union[int, str]:
    """Adds a raw texture.
...
def add_scatter_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_scatter_series(
        x,
        y,
        label=label,
        user_data=user_data,
...
def add_separator(
    ...
    **kwargs,
    ...
    return internal_dpg.add_separator(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_series_value(
    ...
    **kwargs,
    ...
    return internal_dpg.add_series_value(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_shade_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_shade_series(
        x,
        y1,
        label=label,
        user_data=user_data,
...
def add_slider_double(
    ...
    **kwargs,
    ...
    return internal_dpg.add_slider_double(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_slider_doublex(
    ...
    **kwargs,
    ...
    return internal_dpg.add_slider_doublex(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_slider_floatx(
    ...
    **kwargs,
    ...
    return internal_dpg.add_slider_floatx(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_slider_int(
    ...
    **kwargs,
    ...
    return internal_dpg.add_slider_int(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_spacer(
    ...
    **kwargs,
    ...
    return internal_dpg.add_spacer(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_stair_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_stair_series(
        x,
        y,
        label=label,
        user_data=user_data,
...
def add_static_texture(
    ...
    **kwargs,
    ...
    return internal_dpg.add_static_texture(
        width,
        height,
        default_value,
        label=label,
...
def add_stem_series(
    ...
    **kwargs,
    ...
    return internal_dpg.add_stem_series(
        x,
        y,
        label=label,
        user_data=user_data,
...
def add_string_value(
    ...
    **kwargs,
    ...
    return internal_dpg.add_string_value(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_subplots(
    ...
    **kwargs,
    ...
    return internal_dpg.add_subplots(
        rows,
        columns,
        label=label,
        user_data=user_data,
...
def add_tab_bar(
    ...
    **kwargs,
    ...
    return internal_dpg.add_tab_bar(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_tab_button(
    ...
    **kwargs,
    ...
    return internal_dpg.add_tab_button(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_table_cell(
    ...
    **kwargs,
    ...
    return internal_dpg.add_table_cell(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_table_column(
    ...
    **kwargs,
    ...
    return internal_dpg.add_table_column(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_table_row(
    ...
    **kwargs,
    ...
    return internal_dpg.add_table_row(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_template_registry(
    ...
    **kwargs,
    ...
    return internal_dpg.add_template_registry(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_text_point(
    ...
    **kwargs,
    ...
    if "x_offset" in kwargs.keys():
        warnings.warn(
            "x_offset keyword deprecated. See the new offset argument.",
            DeprecationWarning,
            2,
        )
    ...
    if "y_offset" in kwargs.keys():
        warnings.warn(
            "y_offset keyword deprecated. See the new offset argument.",
            DeprecationWarning,
            2,
        )

    return internal_dpg.add_text_point(
        x,
        y,
        label=label,
        user_data=user_data,
...
def add_texture_registry(
    ...
    **kwargs,
    ...
    return internal_dpg.add_texture_registry(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_theme_color(
    ...
    **kwargs,
    ...
    return internal_dpg.add_theme_color(
        target,
        value,
        label=label,
        user_data=user_data,
...
def add_theme_component(
    ...
    **kwargs,
    ...
    return internal_dpg.add_theme_component(
        item_type,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_theme_style(
    ...
    **kwargs,
    ...
    return internal_dpg.add_theme_style(
        target,
        x,
        y,
        label=label,
...
def add_time_picker(
    ...
    **kwargs,
    ...
    return internal_dpg.add_time_picker(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_tooltip(
    ...
    **kwargs,
    ...
    return internal_dpg.add_tooltip(
        parent,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def add_tree_node(
    ...
    **kwargs,
    ...
    return internal_dpg.add_tree_node(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_value_registry(
    ...
    **kwargs,
    ...
    return internal_dpg.add_value_registry(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_viewport_drawlist(
    ...
    **kwargs,
    ...
    return internal_dpg.add_viewport_drawlist(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_viewport_menu_bar(
    ...
    **kwargs,
    ...
    return internal_dpg.add_viewport_menu_bar(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def add_window(
    ...
    **kwargs,
    ...
    return internal_dpg.add_window(
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
        tag=tag,
...
def bind_item_handler_registry(
    item: Union[int, str], handler_registry: Union[int, str], **kwargs
) -> None:
...
def create_fps_matrix(
    eye: Union[List[float], Tuple[float, ...]], pitch: float, yaw: float, **kwargs
) -> Any:
...
def create_lookat_matrix(
    eye: Union[List[float], Tuple[float, ...]],
    target: Union[List[float], Tuple[float, ...]],
    up: Union[List[float], Tuple[float, ...]],
    **kwargs,
) -> Any:
...
def create_orthographic_matrix(
    ...
    **kwargs,
    ...
    return internal_dpg.create_orthographic_matrix(
        left, right, bottom, top, zNear, zFar, **kwargs
    )


def create_perspective_matrix(
    fov: float, aspect: float, zNear: float, zFar: float, **kwargs
) -> Any:
...
def create_rotation_matrix(
    angle: float, axis: Union[List[float], Tuple[float, ...]], **kwargs
) -> Any:
    """New in 1.1. Applies a transformation matrix to a layer.
...
def create_translation_matrix(
    translation: Union[List[float], Tuple[float, ...]], **kwargs
) -> Any:
...
def create_viewport(
    *,
    ...
    decorated: bool = True,
    clear_color: Union[List[float], Tuple[float, ...]] = (0, 0, 0, 255),
    ...
    **kwargs,
    ...
    return internal_dpg.create_viewport(
        title=title,
...
def delete_item(
    item: Union[int, str], *, children_only: bool = False, slot: int = -1, **kwargs
) -> None:
    """Deletes an item..
    ...
    return internal_dpg.delete_item(
        item, children_only=children_only, slot=slot, **kwargs
    )
...
def draw_arrow(
    ...
    **kwargs,
    ...
    return internal_dpg.draw_arrow(
        p1,
        p2,
        label=label,
        user_data=user_data,
...
def draw_bezier_cubic(
    ...
    **kwargs,
    ...
    return internal_dpg.draw_bezier_cubic(
        p1,
        p2,
        p3,
        p4,
...
def draw_bezier_quadratic(
    ...
    **kwargs,
    ...
    return internal_dpg.draw_bezier_quadratic(
        p1,
        p2,
        p3,
        label=label,
...
def draw_circle(
    ...
    **kwargs,
    ...
    return internal_dpg.draw_circle(
        center,
        radius,
        label=label,
        user_data=user_data,
...
def draw_ellipse(
    ...
    **kwargs,
    ...
    return internal_dpg.draw_ellipse(
        pmin,
        pmax,
        label=label,
        user_data=user_data,
...
def draw_image(
    ...
    **kwargs,
    ...
    return internal_dpg.draw_image(
        texture_tag,
        pmin,
        pmax,
        label=label,
...
def draw_image_quad(
    ...
    **kwargs,
    ...
    return internal_dpg.draw_image_quad(
        texture_tag,
        p1,
        p2,
        p3,
...
def draw_polygon(
    ...
    **kwargs,
    ...
    return internal_dpg.draw_polygon(
        points,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def draw_polyline(
    ...
    **kwargs,
    ...
    return internal_dpg.draw_polyline(
        points,
        label=label,
        user_data=user_data,
        use_internal_label=use_internal_label,
...
def draw_rectangle(
    ...
    **kwargs,
    ...
    if "color_upper_left" in kwargs.keys():
        warnings.warn(
            "color_upper_left keyword deprecated. Use corner_colors instead.",
            DeprecationWarning,
            2,
        )
    ...
    if "color_upper_right" in kwargs.keys():
        warnings.warn(
            "color_upper_right keyword deprecated. Use corner_colors instead.",
            DeprecationWarning,
            2,
        )
    ...
    if "color_bottom_right" in kwargs.keys():
        warnings.warn(
            "color_bottom_right keyword deprecated. Use corner_colors instead.",
            DeprecationWarning,
            2,
        )
    ...
    if "color_bottom_left" in kwargs.keys():
        warnings.warn(
            "color_bottom_left keyword deprecated. Use corner_colors instead.",
            DeprecationWarning,
            2,
        )

    return internal_dpg.draw_rectangle(
        pmin,
        pmax,
        label=label,
        user_data=user_data,
...
def draw_triangle(
    ...
    **kwargs,
    ...
    return internal_dpg.draw_triangle(
        p1,
        p2,
        p3,
        label=label,
...
def get_colormap_color(
    colormap: Union[int, str], index: int, **kwargs
) -> Union[List[int], Tuple[int, ...]]:
...
def get_selected_nodes(
    node_editor: Union[int, str], **kwargs
) -> Union[List[int], Tuple[int, ...]]:
...
def get_text_size(
    text: str, *, wrap_width: float = -1.0, font: Union[int, str] = 0, **kwargs
) -> Union[List[float], Tuple[float, ...]]:
...
def highlight_table_row(
    table: Union[int, str], row: int, color: Union[List[int], Tuple[int, ...]], **kwargs
) -> None:
...
def is_table_cell_highlighted(
    table: Union[int, str], row: int, column: int, **kwargs
) -> bool:
...
def load_image(
    file: str, *, gamma: float = 1.0, gamma_scale_factor: float = 1.0, **kwargs
) -> Any:
    ...
    return internal_dpg.load_image(
        file, gamma=gamma, gamma_scale_factor=gamma_scale_factor, **kwargs
    )
...
def sample_colormap(
    colormap: Union[int, str], t: float, **kwargs
) -> Union[List[int], Tuple[int, ...]]:
...
def save_image(
    ...
    **kwargs,
    ...
    return internal_dpg.save_image(
        file, width, height, data, components=components, quality=quality, **kwargs
    )
...
def set_axis_limits_constraints(
    axis: Union[int, str], vmin: float, vmax: float, **kwargs
) -> None:
...
def set_clip_space(
    ...
    **kwargs,
    ...
    return internal_dpg.set_clip_space(
        item, top_left_x, top_left_y, width, height, min_depth, max_depth, **kwargs
    )
...
def set_frame_callback(
    frame: int, callback: Callable, *, user_data: Any = None, **kwargs
) -> str:
    ...
    return internal_dpg.set_frame_callback(
        frame, callback, user_data=user_data, **kwargs
    )
...
def set_item_children(
    item: Union[int, str], source: Union[int, str], slot: int, **kwargs
) -> None:
...
def set_viewport_resize_callback(
    callback: Callable, *, user_data: Any = None, **kwargs
) -> str:
    ...
    return internal_dpg.set_viewport_resize_callback(
        callback, user_data=user_data, **kwargs
    )
...
def show_viewport(
    *, minimized: bool = False, maximized: bool = False, **kwargs
) -> None:
    ...
    return internal_dpg.show_viewport(
        minimized=minimized, maximized=maximized, **kwargs
    )
...
mvNodesCol_MiniMapNodeBackgroundHovered = (
    internal_dpg.mvNodesCol_MiniMapNodeBackgroundHovered
)
mvNodesCol_MiniMapNodeBackgroundSelected = (
    internal_dpg.mvNodesCol_MiniMapNodeBackgroundSelected
)
...
mvStyleVar_TableAngledHeadersTextAlign = (
    internal_dpg.mvStyleVar_TableAngledHeadersTextAlign
)
...
mvNodeStyleVar_LinkLineSegmentsPerLength = (
    internal_dpg.mvNodeStyleVar_LinkLineSegmentsPerLength
)
